...
This check will perform a quick gathering of some basic vacuum parameters and advise if some default values are found along with the critical alert for autovacuum not being enabled..
